...
<% String administorName = (String) session.getAttribute("username");
    ...
    ArrayList newsRealese = jdbc.TeacherQueryAllHomework(administorName);
%>
<body>
<div id="panelwrap">
                ...
                <table id="rounded-corner">
                    ...
                    <tr class="odd">
                        ...
                        <td><a href="#"><img src="images/trash.gif" alt="" title="" border="0"
                                             onclick="javascrtpt:window.location.href = 'DeleteOneHomework?HomeworkId=<%=tem.getHomeworkId()%>'"/></a>
                        </td>
                    </tr>
